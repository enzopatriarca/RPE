                    ...
                    <div class="row">
                        <div class="text-center">
                            ...
                            <img class="mt-4 mb-4" src="/imgs/logo.png" height="80px" alt="Logo_Itaipu">
                                <h1 class="titulo_1">Registrar Local</h1>
                        </div>
                        
                        <div style="margin-left: 20px" class="col-md-4"> 
                            <form style="width: 500px; margin:auto;" method="POST" action="{{route('registro.local')}}">
                                @if(session('message'))
                                ...
                                <div class="mt-4">
                                    <input style="border-color: black;" value="{{old('local')}}" type="text" class="form-control" size="10px" id="local" placeholder="Nome do Local" name="local">
                                </div>
                                @if ($errors->first('local'))
                                <div style="margin-top: 10px" class="alert-danger">{{$errors->first('local')}}</div>
                                @endif
